...
var address = "16VaRKie1kZfBpVFj5skGkbMt6qzQtn5bW"; // The bitcoin address to receive donations. Change to yours
var popup = false; // Set to true if you want a popup to pay bitcoin
var currencyCode = "JPY"; // Change to your default currency. Choose from https://blockchain.info/ticker?cors=true
var qrcode = true; // Set to false to disable qrcode
var link = true; // Set to false to disable generating hyperlink
var organization = "mimoex"; // Change to your organization name
var mbits = true; // Set to false to display bitcoin traditionally
var defaultAmountToDonate = 5; // Default amount to donate
var defaultCurrency = 'JPY'; // Default currency to fallback
